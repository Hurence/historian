...
import org.apache.spark.sql.functions.{avg, collect_list, first, lit, max, min, _}
...
/**
  ...
  * columns.
  */
final class ChunkyfierStreaming(override val uid: String)
  extends Model[ChunkyfierStreaming] with DefaultParamsWritable {
...
/*
  ...
  override def copy(extra: ParamMap): ChunkyfierStreaming = {
    defaultCopy[ChunkyfierStreaming](extra).setParent(parent)
  }
