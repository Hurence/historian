...
public class SolrDocumentBuilder {
    ...
    public static SolrInputDocument fromChunk(ChunkVersionCurrent chunk) {
        ...
        doc.setField(HistorianChunkCollectionFieldsVersionCurrent.CHUNK_TREND, chunk.getTrend());
        doc.setField(HistorianChunkCollectionFieldsVersionCurrent.CHUNK_OUTLIER, chunk.getOutlier());
