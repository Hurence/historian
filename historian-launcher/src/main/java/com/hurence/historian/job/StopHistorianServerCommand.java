...
public class StopHistorianServerCommand {
    ...
    public static void main(String[] args) {
        SingleCommand<StopHistorianServerCommand> parser = SingleCommand.singleCommand(StopHistorianServerCommand.class);
        StopHistorianServerCommand cmd = parser.parse(args);
        cmd.run();
    }
