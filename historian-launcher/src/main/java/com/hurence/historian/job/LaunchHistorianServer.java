...
public class LaunchHistorianServer {
    ...
    public static void main(String[] args) {
        SingleCommand<LaunchHistorianServer> parser = SingleCommand.singleCommand(LaunchHistorianServer.class);
        LaunchHistorianServer cmd = parser.parse(args);
        cmd.run();
    }
