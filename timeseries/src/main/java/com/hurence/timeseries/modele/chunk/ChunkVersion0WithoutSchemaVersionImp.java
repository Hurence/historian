...
public class ChunkVersion0WithoutSchemaVersionImp implements ChunkVersion0 {
    ...
    private ChunkVersion0WithoutSchemaVersionImp(String name,
    ...
    public static class Builder {
        ...
        public ChunkVersion0WithoutSchemaVersionImp build() {
            return new ChunkVersion0WithoutSchemaVersionImp( name,
