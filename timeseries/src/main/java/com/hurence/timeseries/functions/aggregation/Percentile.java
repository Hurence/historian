...
import com.hurence.timeseries.functions.ChronixAggregation;
...
public final class Percentile implements ChronixAggregation<MetricTimeSeries> {
    ...
    public void execute(MetricTimeSeries timeSeries, FunctionValueMap functionValueMap) {
        ...
        functionValueMap.add(this, com.hurence.timeseries.functions.math.Percentile.evaluate(timeSeries.getValues(), percentile));
    }
