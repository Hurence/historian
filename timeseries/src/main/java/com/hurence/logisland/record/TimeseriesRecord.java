...
public class TimeseriesRecord extends StandardRecord {
    ...
    private static final BinaryCompactionConverterOfRecord converter = new BinaryCompactionConverterOfRecord.Builder().build();
    ...
    public static List<Point> getPointStream(String chunkValue, long chunkStart, long chunkEnd) throws IOException {
        ...
        return converter.deSerializeTimeseries(chunkBytes, chunkStart, chunkEnd);
    }
