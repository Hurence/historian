...
public class ChunkCurrentVersionImplTest {

    private static final Logger logger = LoggerFactory.getLogger(ChunkCurrentVersionImplTest.class);
    ...
    public void testTruncate() {
        ...
        ChunkVersionCurrent chunk = ChunkBuilderHelper.fromPointsAndTags("metric 1",
        ...
        //        truncated chunk
        ChunkVersionCurrent truncatedChunk = chunk.truncate(301, 799);
