...
//    assertEquals(1598.8, chunktoCheck.getQualityFirst)
//    assertEquals(1086.4, chunktoCheck.getQualityMin)
//    assertEquals(2046.6, chunktoCheck.getQualityMax)
//    assertEquals(476305.0, chunktoCheck.getQualitySum)
//    assertEquals(1653.8368, chunktoCheck.getQualityAvg)
}
