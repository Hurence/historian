...
/**
  ...
  * columns.
  */
final class Chunkytizer(override val uid: String)
  extends Model[Chunkytizer] with DefaultParamsWritable {
  ...
  def transform(df: Dataset[_]): DataFrame = {
    ...
    val w = Window.partitionBy(grougingCols: _*).orderBy(col($(timestampCol)))
 ...
 */
  ...
  override def copy(extra: ParamMap): Chunkytizer = {
    defaultCopy[Chunkytizer](extra).setParent(parent)
  }
