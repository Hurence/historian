...
//    val fields = s"${HistorianChunkCollectionFieldsVersion0.ID}"
//
//    val solrOpts = Map(
//      "zkhost" -> options.zkHosts,
//      "collection" -> options.timeseriesCollectionName,
...
//         "splits_per_shard"-> "50",*/
//      "fields" -> fields,
//      "filters" -> s"""${HistorianChunkCollectionFieldsVersion0.COMPACTIONS_RUNNING}:"$jobId""""
//    )
//    logger.info("solrOpts : {}", solrOpts.mkString("\n{", "\n", "}"))
//    SparkSolrUtils.loadFromSolR(spark, solrOpts)
//  }
//
//  private def saveNewChunksToSolR(timeseriesDS: DataFrame) = {
...
//        r.getField(HistorianChunkCollectionFieldsVersion0.CHUNK_SUM).asDouble(),
//        r.getField(HistorianChunkCollectionFieldsVersion0.CHUNK_TREND).asBoolean(),
//        r.getField(HistorianChunkCollectionFieldsVersion0.CHUNK_OUTLIER).asBoolean(),
//        if (r.hasField(HistorianChunkCollectionFieldsVersion0.CHUNK_SAX)) r.getField(HistorianChunkCollectionFieldsVersion0.CHUNK_SAX).asString() else "",
//        r.getField(HistorianChunkCollectionFieldsVersion0.CHUNK_ORIGIN).asString())
//      )
//      .toDF(HistorianChunkCollectionFieldsVersion0.ID,
...
//        HistorianChunkCollectionFieldsVersion0.CHUNK_SUM,
//        HistorianChunkCollectionFieldsVersion0.CHUNK_TREND,
//        HistorianChunkCollectionFieldsVersion0.CHUNK_OUTLIER,
//        HistorianChunkCollectionFieldsVersion0.CHUNK_SAX,
//        HistorianChunkCollectionFieldsVersion0.CHUNK_ORIGIN)
//
//    if (options.useCache) {
//      savedDF.cache()
//    }
...
//  }
//
//  private def chunkIntoSeveralHistorianChunkCollectionFieldsVersion0(metricType: String, metricName: String,
...
//   * @return
//   */
//  private def mergeChunks(sparkSession: SparkSession, solrDf: DataFrame): DataFrame = {
//    val dailyChunks: DataFrame = chunkDailyMetrics(solrDf)
//    dailyChunks
//  }
//
//  private def chunkDailyMetrics(solrDf: DataFrame): Dataset[Chunk] = {
//    val groupedChunkDf = solrDf
//      .groupBy(
//        col(HistorianChunkCollectionFieldsVersion0.NAME),
//        col(HistorianChunkCollectionFieldsVersion0.CHUNK_YEAR),
...
//      f.col(HistorianChunkCollectionFieldsVersion0.NAME)
//    )
//      .agg(
...
//        f.count(HistorianChunkCollectionFieldsVersion0.NAME).as(CompactorJobReport.JOB_NUMBER_OF_CHUNK_INPUT),
//        f.countDistinct(HistorianChunkCollectionFieldsVersion0.NAME).as(CompactorJobReport.JOB_TOTAL_METRICS_RECHUNKED),
...
//      f.col(HistorianChunkCollectionFieldsVersion0.ID)
//    ).as[String]
//
...
//    chunkIds.rdd.map(id => {
//      val updateDoc = new SolrInputDocument
//      updateDoc.setField(HistorianChunkCollectionFieldsVersion0.ID, id)
//      updateDoc.setField(HistorianChunkCollectionFieldsVersion0.COMPACTIONS_RUNNING, addJobIdTag)
//      updateDoc
//    })
...
//    val query = s"""${HistorianChunkCollectionFieldsVersion0.COMPACTIONS_RUNNING}:"$jobId""""
...
//    val query = s"""${HistorianChunkCollectionFieldsVersion0.CHUNK_ORIGIN}:"$jobId""""
//    deleteByQuery(options.timeseriesCollectionName, options.zkHosts, query)
//  }
//  /**
