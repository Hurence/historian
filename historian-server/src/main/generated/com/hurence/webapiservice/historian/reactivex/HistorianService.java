...
public class HistorianService {
   ...
   * @param myResult return chunks of timeseries as an array of <pre> {  : "the total number of point returned",  : [ {  : "the metric name",  : { "tag name 1" : "tag value", ... },  : [ [value(double), timestamp(long)], ... ] } ] } </pre>
   * @return himself
   */
