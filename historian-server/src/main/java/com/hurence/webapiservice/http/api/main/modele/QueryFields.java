package com.hurence.webapiservice.http.api.main.modele;

public class QueryFields {
    public static final String QUERY_PARAM_FROM = "from";
    public static final String QUERY_PARAM_TO = "to";
    public static final String QUERY_PARAM_NAME = "metrics";
    ...
    public static String QUERY_PARAM_REF_ID = "refId";
}
