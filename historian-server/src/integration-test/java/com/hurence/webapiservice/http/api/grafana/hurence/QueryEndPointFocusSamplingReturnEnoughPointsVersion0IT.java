...
public class QueryEndPointFocusSamplingReturnEnoughPointsVersion0IT {

    private static WebClient webClient;
    private static Logger LOGGER = LoggerFactory.getLogger(QueryEndPointFocusSamplingReturnEnoughPointsVersion0IT.class);
    ...
    public static SolrInjector buildInjector() {
        ...
        AbstractVersion0SolrInjector injectorChunk = Version0SolrInjectorOneMetricMultipleChunksSpecificPoints.fromMetricsAndPoints(
                "metric_10_chunk", pointsByChunk10Chunks
        );
        return injectorChunk;
